...
const mockTestSets = [
  { id: "visual-quality", name: "Visual Quality Test Set", samples: 300 },
  { id: "geometric-accuracy", name: "Geometric Accuracy Test Set", samples: 250 },
  { id: "language-understanding", name: "Language Understanding Test Set", samples: 200 },
]
      ...
      <main className="flex-1 overflow-auto ml-16">
        ...
        <header className="border-b border-border bg-card px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-foreground font-space-grotesk">Model Testing</h1>
              ...
              {!isConfigured ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                        <CardTitle className="font-space-grotesk">Available Test Sets</CardTitle>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="font-space-grotesk">Active Test Runs</CardTitle>
                        <CardDescription>Monitor ongoing test executions</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        {testRuns.length === 0 ? (
